...
public class JfmxPageReqVO extends PageParam {
    ...
    @Schema(description = "基层经账号")
    private String jcjzh;

    @Schema(description = "基层经户名")
    private String jcjhm;

    @Schema(description = "基层经行号")
    private String jcjhh;

    @Schema(description = "基层经比例")
    private BigDecimal jcjbl;

    @Schema(description = "基层经金额")
    private BigDecimal jcjje;

    @Schema(description = "基层经委书号")
    private String jcwsh;

    @Schema(description = "税地所账号")
    private String sdszh;

    @Schema(description = "税地所户名")
    private String sdshm;

    @Schema(description = "税地所行号")
    private String sdshh;

    @Schema(description = "税地所比例")
    private BigDecimal sdsbl;

    @Schema(description = "税地所金额")
