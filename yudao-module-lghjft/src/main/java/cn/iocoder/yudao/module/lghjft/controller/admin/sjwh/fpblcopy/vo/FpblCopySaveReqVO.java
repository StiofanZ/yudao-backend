...
public class FpblCopySaveReqVO {
    ...
    @NotNull(message = "比例ID不能为空", groups = {UpdateGroup.class})
    @Min(value = 1, message = "比例ID必须大于0", groups = {UpdateGroup.class})
    ...
    @Schema(description = "条件", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "条件不能为空")
    @Size(max = 5000, message = "条件长度不能超过5000个字符")
    private String tj;
