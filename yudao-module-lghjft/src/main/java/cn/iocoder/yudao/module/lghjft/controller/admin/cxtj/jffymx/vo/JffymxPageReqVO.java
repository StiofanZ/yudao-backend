package cn.iocoder.yudao.module.lghjft.controller.admin.cxtj.jffymx.vo;
...
@Schema(description = "管理后台 - 经费分月明细分页 Request VO")
@Data
public class JffymxPageReqVO extends PageParam {
    ...
    // ---- V1 还原：以下字段在 V1 selectJffymxList 中存在但 V2 遗漏 ----
