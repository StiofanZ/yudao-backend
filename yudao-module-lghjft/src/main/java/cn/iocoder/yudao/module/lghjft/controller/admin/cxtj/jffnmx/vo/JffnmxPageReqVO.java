...
@Schema(description = "管理后台 - 经费分年明细分页 Request VO")
@Data
public class JffnmxPageReqVO extends PageParam {
    ...
    // ---- V1 还原：以下字段在 V1 selectJffnmxList 中存在但 V2 遗漏 ----
