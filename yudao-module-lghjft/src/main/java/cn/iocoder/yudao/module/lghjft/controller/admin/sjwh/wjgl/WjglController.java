...
public class WjglController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh-wjgl:query')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh-wjgl:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh-wjgl:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh-wjgl:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh-wjgl:export')")
