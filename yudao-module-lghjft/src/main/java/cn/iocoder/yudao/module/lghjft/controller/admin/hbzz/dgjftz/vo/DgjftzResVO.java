...
/**
 * 代管经费台账 Response VO — v1 selectDgjftzList 映射 gh_jf + cxtj_cbjqrfb
 */
@Schema(description = "管理后台 - 代管经费台账 Response VO")
@Data
...
public class DgjftzResVO {
    ...
    /* ---- cxtj_cbjqrfb sub-table fields ---- */
    @Schema(description = "返拨金额")
