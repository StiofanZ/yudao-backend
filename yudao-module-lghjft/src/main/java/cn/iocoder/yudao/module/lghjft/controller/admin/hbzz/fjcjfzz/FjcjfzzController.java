package cn.iocoder.yudao.module.lghjft.controller.admin.hbzz.fjcjfzz;
...
@Tag(name = "管理后台 - 返基层账")
@RestController
@RequestMapping("/lghjft/hbzz/fjcjfzz")
@Validated
public class FjcjfzzController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:hbzz-fjcjfzz:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:hbzz-fjcjfzz:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:hbzz-fjcjfzz:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:hbzz-fjcjfzz:export')")
