...
//
//    @Resource
//    private GhWfJfhjsqMapper wfJfhjSqMapper;
//
//    @Override
...
//       // 4. 查询你的业务表数据
//            GhWfJfhjsqDO data = wfJfhjSqMapper.selectOne(
//                    new LambdaQueryWrapper<GhWfJfhjsqDO>()
//                            .eq(GhWfJfhjsqDO::getProcessInstanceId, processId)
//            );
//            if (data == null) return;
//            System.out.println("查询到的业务表原始数据：id=" + data.getId() + "，lcslId=" + data.getProcessInstanceId());
//            // 5. 写入你的业务表（只填核心字段）
