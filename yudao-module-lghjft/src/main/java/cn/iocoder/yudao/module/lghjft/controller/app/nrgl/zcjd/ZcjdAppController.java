...
import cn.iocoder.yudao.module.lghjft.controller.app.nrgl.zcjd.vo.ZcjdListAppReqVO;
...
public class ZcjdAppController {
    ...
    public CommonResult<List<ZcjdRespVO>> getZcjdList(@Valid ZcjdListAppReqVO reqVO) {
