package cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.znjtz;
...
import cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.znjtz.vo.ZnjtzResVO;
...
import cn.iocoder.yudao.module.lghjft.service.sjwh.znjtz.ZnjtzService;
...
@Tag(name = "管理后台 - 滞纳金台账")
@RestController
@RequestMapping("/lghjft/sjwh/znjtz")
@Validated
public class ZnjtzController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjtz:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjtz:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjtz:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjtz:query')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjtz:export')")
