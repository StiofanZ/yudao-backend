...
public class GhJfCbjqfResVO {
    ...
    @Schema(description = "cbjqfzt")
    private String cbjqfzt;

    @Schema(description = "cbjqfrq")
    private LocalDateTime cbjqfrq;

    @Schema(description = "cbjqfjg")
    private String cbjqfjg;

    @Schema(description = "cbjjsbfjczt")
    private String cbjjsbfjczt;

    @Schema(description = "cbjjsbfjcrq")
    private LocalDateTime cbjjsbfjcrq;
