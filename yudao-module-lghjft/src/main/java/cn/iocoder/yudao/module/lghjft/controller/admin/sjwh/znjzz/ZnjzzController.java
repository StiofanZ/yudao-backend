package cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.znjzz;
...
import cn.iocoder.yudao.module.lghjft.service.sjwh.znjzz.ZnjzzService;
...
@Tag(name = "管理后台 - 滞纳金做账")
@RestController
@RequestMapping("/lghjft/sjwh/znjzz")
@Validated
public class ZnjzzController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjzz:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjzz:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjzz:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjzz:query')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:znjzz:export')")
