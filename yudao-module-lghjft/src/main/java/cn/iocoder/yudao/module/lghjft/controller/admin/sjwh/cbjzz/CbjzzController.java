package cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.cbjzz;
...
import cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.cbjzz.vo.CbjzzPageReqVO;
import cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.cbjzz.vo.CbjzzResVO;
import cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.cbjzz.vo.CbjzzSaveReqVO;
import cn.iocoder.yudao.module.lghjft.dal.dataobject.sjwh.cbjzz.CbjzzDO;
import cn.iocoder.yudao.module.lghjft.service.sjwh.cbjzz.CbjzzService;
...
@Tag(name = "管理后台 - 筹备金做账")
@RestController
@RequestMapping("/lghjft/sjwh/cbjzz")
@Validated
public class CbjzzController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:cbjzz:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:cbjzz:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:cbjzz:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:cbjzz:query')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:cbjzz:export')")
