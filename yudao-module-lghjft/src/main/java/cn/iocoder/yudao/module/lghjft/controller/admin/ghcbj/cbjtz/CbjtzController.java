package cn.iocoder.yudao.module.lghjft.controller.admin.ghcbj.cbjtz;
...
import cn.iocoder.yudao.module.lghjft.service.ghcbj.cbjtz.CbjtzService;
...
@Tag(name = "管理后台 - 筹备金台账")
@RestController
@RequestMapping("/lghjft/ghcbj/cbjtz")
@Validated
public class CbjtzController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjtz:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjtz:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjtz:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjtz:export')")
