package cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.ghjfzz;
...
import cn.iocoder.yudao.module.lghjft.service.sjwh.ghjfzz.GhjfzzService;
...
@RestController
@RequestMapping("/lghjft/sjwh/ghjfzz")
@Validated
public class GhjfzzController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghjfzz:query')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghjfzz:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghjfzz:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghjfzz:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghjfzz:export')")
