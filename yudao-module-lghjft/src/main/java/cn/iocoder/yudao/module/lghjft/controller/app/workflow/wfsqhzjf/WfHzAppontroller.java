...
import cn.iocoder.yudao.module.lghjft.controller.app.workflow.wfsqhzjf.vo.WfHzAppRespVO;
...
//    @PreAuthorize("@ss.hasPermission('lghjft:wf-hz:query')")
    public CommonResult<WfHzAppRespVO> getWfHz(@RequestParam("id") Long id) {
        WfHzRespVO wfHz = wfHzService.getDetail(id);
        return success(BeanUtils.toBean(wfHz, WfHzAppRespVO.class));
    }
