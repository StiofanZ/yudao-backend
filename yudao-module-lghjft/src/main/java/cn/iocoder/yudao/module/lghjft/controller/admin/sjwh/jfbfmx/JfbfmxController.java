package cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.jfbfmx;
...
import cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.jfbfmx.vo.*;
...
import cn.iocoder.yudao.module.lghjft.dal.dataobject.sjwh.jfbfmx.JfbfmxDO;
import cn.iocoder.yudao.module.lghjft.dal.dataobject.sjwh.szqzjzdc.SzqzjzdcDO;
import cn.iocoder.yudao.module.lghjft.service.sjwh.jfbfmx.JfbfmxService;
...
@RestController
@RequestMapping("/lghjft/sjwh/jfbfmx")
@Validated
public class JfbfmxController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh:jfbfmx:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh:jfbfmx:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh:jfbfmx:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh:jfbfmx:query')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:sjwh:jfbfmx:export')")
