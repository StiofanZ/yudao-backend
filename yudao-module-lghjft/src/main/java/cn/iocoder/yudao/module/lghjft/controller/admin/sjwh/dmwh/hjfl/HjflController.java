package cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.dmwh.hjfl;
...
import cn.iocoder.yudao.module.lghjft.controller.admin.sjwh.dmwh.hjfl.vo.HjflResVO;
...
import cn.iocoder.yudao.module.lghjft.service.sjwh.dmwh.hjfl.HjflService;
...
@Tag(name = "管理后台 - 户籍分类")
@RestController
@RequestMapping("/lghjft/sjwh/dmwh/hjfl")
@Validated
public class HjflController {
    ...
    public void exportHjflExcel(@Valid HjflPageReqVO pageReqVO,
        ...
        // 导出 Excel
        ExcelUtils.write(response, "户籍分类.xls", "数据", HjflResVO.class,
                BeanUtils.toBean(list, HjflResVO.class));
    }
