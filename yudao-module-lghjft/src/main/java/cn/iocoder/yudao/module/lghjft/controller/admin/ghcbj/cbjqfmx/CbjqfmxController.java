package cn.iocoder.yudao.module.lghjft.controller.admin.ghcbj.cbjqfmx;
...
import cn.iocoder.yudao.module.lghjft.controller.admin.ghcbj.cbjqfmx.vo.CbjqfmxResVO;
...
import cn.iocoder.yudao.module.lghjft.service.ghcbj.cbjqfmx.CbjqfmxService;
...
public class CbjqfmxController {
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjqfmx:create')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjqfmx:update')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjqfmx:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjqfmx:query')")
    ...
    @PreAuthorize("@ss.hasPermission('lghjft:ghcbj-cbjqfmx:export')")
