...
(
    ...
    `status`      tinyint                                                       NOT NULL DEFAULT '0' COMMENT '状态 (0:未审核, 1:已审核, 2:已发布, 3:已过期, 4:已下架)',
    `dept_id`     bigint                                                                 DEFAULT NULL COMMENT '发布部门编号',
...
(
    ...
    `dept_id`     bigint                                                                 DEFAULT NULL COMMENT '发布部门编号',
    `kjfw`        tinyint                                                       NOT NULL DEFAULT '1' COMMENT '可见范围 (1:完全可见, 2:下级可见, 3:本级可见)',
    `fjlj`        varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci          DEFAULT NULL COMMENT '附件路径',
